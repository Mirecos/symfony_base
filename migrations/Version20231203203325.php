 ...
 */
final class Version20231203203325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE album (id INT AUTO_INCREMENT NOT NULL, style_id INT DEFAULT NULL, artist_id INT DEFAULT NULL, name VARCHAR(50) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_39986E43BACD6074 (style_id), INDEX IDX_39986E43B7970CF8 (artist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
